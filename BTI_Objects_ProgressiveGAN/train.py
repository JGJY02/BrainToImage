...
def setup_snapshot_image_grid(G, training_set, 
    ...
    return (gw, gh), reals, labels, encoded_eegs
...
def train_progressive_gan(
    ...
    grid_size, grid_reals, grid_labels, grid_latents = setup_snapshot_image_grid(G, training_set, encoder_model,  **config.grid)
