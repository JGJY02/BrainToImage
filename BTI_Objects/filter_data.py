...
input_file = args.dataset_pickle
...
## Access filter data 
data_pd = pd.read_pickle(f"{input_dir}/{input_file}_eeg_data.pkl") #Change file_to_process to match output later on
...
output_file = f"filtered_{args.dataset_pickle}_eeg_data.pkl"
