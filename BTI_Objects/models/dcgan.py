...
#Generator model
def build_dc_generator(latent_dim,num_channels,num_classes,activation="relu",final_activation="tanh",verbose=False):
...
# Complete GAN model
def build_DCGgan(latent_dim, num_classes, gen, dis, verbose=False):
